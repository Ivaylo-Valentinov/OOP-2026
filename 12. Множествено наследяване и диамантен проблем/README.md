...
Имплементирайте функция **annual_raise** за всяка една от ролите, която калкулира и увеличава заплатата на съответния служител по следния начин:
...
3. Увеличението на заплатата при **automation QA** е:
