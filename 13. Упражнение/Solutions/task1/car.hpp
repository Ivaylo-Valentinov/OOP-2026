...
constexpr double VH_KM_PER_PSG = 100;
...
public:
	Car(size_t id, const char* const model, const double range, const size_t seats):
	...
	double getRange() const override {
		return maxRange - VH_KM_PER_PSG * numPassengers;
	}
